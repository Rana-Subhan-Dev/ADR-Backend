...
const createLawFirm = asyncHandler(async (req, res) => {
  ...
  return res
    .status(201)
    .json(new ApiResponse(201, result, "Law firm added successfully."));
});
...
const getLawFirmById = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, result, "Law firm fetched successfully."));
});
...
const updateLawFirm = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, result, "Law firm updated successfully."));
});
...
const createAttorney = asyncHandler(async (req, res) => {
  const result = await attorneyLawFirmService.createAttorney(
    req.body,
    req.user,
  );
  return res
    .status(201)
    .json(new ApiResponse(201, result, "Attorney added successfully."));
});
...
const getAttorneys = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, result, "Attorneys fetched successfully."));
});

const getAttorneyById = asyncHandler(async (req, res) => {
  const result = await attorneyLawFirmService.getAttorneyById(
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, result, "Attorney fetched successfully."));
});

const updateAttorney = asyncHandler(async (req, res) => {
  const result = await attorneyLawFirmService.updateAttorney(
    req.params.attorneyId,
    req.body,
    req.user,
  );
  return res
    .status(200)
    .json(new ApiResponse(200, result, "Attorney updated successfully."));
});
...
const deleteAttorney = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, null, "Attorney deleted successfully."));
});
