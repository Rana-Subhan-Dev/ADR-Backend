...
const inviteParticipant = asyncHandler(async (req, res) => {
  ...
  res
    .status(201)
    .json(new ApiResponse(201, result, "Participant invited successfully."));
});
...
const updateParticipant = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, result, "Participant updated successfully."));
});
const resendInvitation = asyncHandler(async (req, res) => {
  const result = await participantService.resendInvitation(
    req.params.caseId,
    req.params.participantId,
    req.user,
  );
...
const revokeInvitation = asyncHandler(async (req, res) => {
  const result = await participantService.revokeInvitation(
    req.params.caseId,
    req.params.participantId,
    req.body.reason,
    req.user,
  ...
  res
    .status(200)
    .json(new ApiResponse(200, result, "Invitation revoked successfully."));
});
const updateAccess = asyncHandler(async (req, res) => {
  const result = await participantService.updateAccess(
    req.params.caseId,
    req.params.participantId,
  ...
  res
    .status(200)
    .json(
      new ApiResponse(200, result, "Participant access updated successfully."),
    );
});
const getAvailableNeutrals = asyncHandler(async (req, res) => {
  const result = await participantService.getAvailableNeutrals(
    req.params.caseId,
    req.user,
  );
  res
    .status(200)
    .json(
      new ApiResponse(200, result, "Available neutrals fetched successfully."),
    );
});
const assignNeutral = asyncHandler(async (req, res) => {
  const result = await participantService.assignNeutral(
    req.params.caseId,
    req.body,
    req.user,
    {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, result, "Neutral assigned successfully."));
});
