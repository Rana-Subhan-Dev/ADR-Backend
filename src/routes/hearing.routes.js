...
const { caseIdSchema, hearingIdSchema, scheduleHearingSchema, updateHearingSchema, rescheduleHearingSchema, cancelHearingSchema, getHearingsSchema, availabilitySchema, availableSlotsSchema } = require("../validations/hearing.validation");
...
router.post(
    "/:hearingId/cancel", 
    validate(hearingIdSchema, "params"), 
    validate(cancelHearingSchema), hearingController.cancelHearing);
