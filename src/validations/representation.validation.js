...
const { RepresentationDesignation } = require("../constants/representation.constants");
...
const createRepresentationSchema = Joi.object({
  ...
  role: Joi.string().valid(...Object.values(RepresentationDesignation)).required(),
});
...
const getRepresentationsSchema = Joi.object({
  ...
  role: Joi.string().valid(...Object.values(RepresentationDesignation)).optional(),
